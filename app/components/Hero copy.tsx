      ...
      <div className="w-full h-full lg:py-28 xl:p-28 md:p-12 p-10">
        <motion.div
         ...
         >
          ...
          >
            ...
            <picture>
              <source media="(max-width: 425px)" srcSet={imagenElegantMobile} />
               ...
               <Image className="md:rounded-sm rounded-lg" src={imagenElegant} alt={'elegant'} layout={'fill'} objectFit={'cover'}>
                </Image>
               </picture>
          ...
          className="hero-4 ease-in md:hover:scale-105 transition-all duration-200 relative xl:max-h-[440px] xl:min-h-[480px] xl:max-w-[340px] xl:min-w-[280px] lg:max-h-[280px] lg:min-h-[240px] lg:min-w-[160px] lg:max-w-[160px] md:border-[4px] md:min-h-[230px] md:max-h-[240px] md:max-w-auto md:rounded-sm md:border-white md:w-auto md:h-auto h-32 w-16 rounded-lg border-2 border-white">
            
            <picture>
              <source media="(max-width: 425px)" srcSet={imagePortfolioMobile} />
               <source media="(min-width: 426px)" srcSet={imagePortfolio} />
               <Image className="md:rounded-sm rounded-lg" src={imagePortfolio} alt={'portfolio'} layout={'fill'} objectFit={'cover'}>
                </Image>
               </picture>
          ...
          className="hero-5 md:hover:scale-105 transition-all ease-in duration-200 relative xl:max-h-[440px] xl:min-h-[480px] xl:max-w-[340px] xl:min-w-[280px] lg:max-h-[280px] lg:min-h-[240px] lg:min-w-[160px] lg:max-w-[160px] md:border-[4px] md:min-h-[230px] md:max-h-[240px] md:max-w-auto md:rounded-sm md:border-white md:w-auto md:h-auto h-32 w-16 rounded-lg border-2 border-white md:hover:border-white hover:border-0">
            
            <picture>
              <source media="(max-width: 425px)" srcSet={imageGalleryMobile} />
               <source media="(min-width: 426px)" srcSet={imageGallery} />
               <Image className="md:rounded-sm rounded-lg" src={imageGallery} alt={'gallery'} layout={'fill'} objectFit={'cover'}>
                </Image>
               </picture>
          </div>
          ...
          className="hero-6 hover:scale-105 transition-all ease-in duration-200 relative xl:max-h-[440px] xl:min-h-[480px] xl:max-w-[340px] xl:min-w-[280px] lg:max-h-[280px] lg:min-h-[240px] lg:min-w-[160px] lg:max-w-[160px] md:border-[4px] md:min-h-[230px] md:max-h-[240px] md:max-w-auto md:rounded-sm md:border-white md:w-auto md:h-auto h-32 w-16 rounded-lg border-2 border-white md:hover:border-white hover:border-0">
            
            <picture>
              <source media="(max-width: 425px)" srcSet={imagePropertyMobile} />
               <source media="(min-width: 426px)" srcSet={imageProperty} />
               <Image className="md:rounded-sm rounded-lg " src={imageProperty} alt={'property'} layout={'fill'} objectFit={'cover'}>
                </Image>
               </picture>
