...
function HeaderPorfolio({}: Props) {
  ...
  const handleButtonClick2 = () => {
    ...
    const [tamañoNav, setTamañoNav] = useState("w-full h-[115px] fixed left-0 top-0 ease-in duration-200 z-50")
...
useEffect(() => {
     const changeColor = () => {
        if(window.scrollY >= 90) {
            setColor('#141627')
            setTextColor('#F7F7F7')
            setTamañoNav("w-full h-[62px] md:h-[82px] max-w-auto fixed left-0 top-0 z-50 shadow-xl ease-in duration-200 shadow-[#29F2CD]/30 shadow-lg")
            ...
            setTextColor('#ffffff')
            setTamañoNav("w-full h-[115px] fixed left-0 top-0 z-50 ease-in duration-200")
