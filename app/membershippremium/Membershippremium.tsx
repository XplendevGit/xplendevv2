  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0A192F] to-[#112240] flex flex-col items-center py-12 px-6">
      ...
      <section className="grid grid-cols-1 gap-8 w-full max-w-xl">
        ...
        {/* Plan Details */}
        <div className="bg-[#112240] border border-[#FF00FF] rounded-lg p-8 text-center shadow-lg mx-auto flex flex-col">
      ...
      <section className="mt-16 w-full max-w-6xl text-center">
        ...
        <p className="text-lg text-gray-400 mb-12">Con nuestro plan premium, obtienes soluciones avanzadas para sitios más complejos como tiendas en línea o plataformas de aprendizaje.</p>
